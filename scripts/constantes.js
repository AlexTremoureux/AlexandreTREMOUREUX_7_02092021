...
export const wrapperIngredientInputFilter = filterIngredientSelect.querySelector('.wrapperIngredientInputFilter')
export const wrapperDevicesInputFilter = filterDevicesSelect.querySelector('.wrapperDevicesInputFilter')
export const wrapperUstensilsInputFilter = filterUstensilsSelect.querySelector('.wrapperUstensilsInputFilter')
export const listItemsIngredients = filterIngredientSelect.querySelector('.listItems');
export const listItemsDevices = filterDevicesSelect.querySelector('.listItems');
export const listItemsUstensils = filterUstensilsSelect.querySelector('.listItems');
